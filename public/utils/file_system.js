...
const fs_delete_folder_dir = async (srcUrl) => {
    const resp = fs.rm(srcUrl, { recursive: true });
    return resp;
};
...
module.exports = { fs_delete_file_from_storage, fs_fileExist, fs_createFile,
    ...
    fs_appendFile, fs_deleteFileFromDir, fs_renameFile, fs_writeData_with_flag_opt, fs_delete_folder_dir
}